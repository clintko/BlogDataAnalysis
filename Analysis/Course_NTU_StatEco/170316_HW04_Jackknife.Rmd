...
# Question 1
Compute the mean and standard error of the mean for the fish and copepod density (all data points) respectively using Jackknife. Plot the histogram of Jackknife means.
...
# Question 2
Compute the regression coefficients for fish = beta0+beta1 * copepod and Jackknife SE of beta0 and beta1. Plot the histogram of Jackknife beta0 and beta1
...
we can also show the result in boxplot
```{r}
boxplot(
    cpod$Val,
    jKnife_CpodMean$Val, 
...
title(main="boxplot of Bootstrap Mean")
axis(1, at=c(1,2,3,4,5,6), labels=FALSE)
text(c(1,2,3,4,5,6)-0.2, par("usr")[3] - 330, 
     labels = c(
         "Copepod\n(Sample)", "Copepod\n(Bootstrap)", "Copepod\n(Jackknife)", 
...
#points(x=1.5, y=beta$b1, pch=20, col="#cd5b45")
#text(  x=1.5, y=beta$b1 - 30,
#       cex=0.7, col="Red",
#       "Beta1\nSample")

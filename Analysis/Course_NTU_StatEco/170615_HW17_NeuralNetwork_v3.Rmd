---
title: "170615_HW17_NeuralNetwork_v3"
author: "Kuei Yueh Ko"
date: "2017年6月22日"
...
gp <- gp +
    geom_point(color=myDat$Color, size=2) +
    theme_bw()
print(gp)
```
...
# Training MSE
plot(res$MSE_Train, pch=20, axes=T, 
     xlab="Index", 
     ylab="MSE (Training)", 
     cex=1.0, col="red")
axis(2, ylim=range(res$MSE_Train))

# Testing MSE
par(new = T)
plot(res$MSE_Test,  pch=20, axes=F, 
     xlab=NA, ylab=NA, 
     cex=0.5, col="blue")
axis(4, ylim=range(res$MSE_Test))
mtext("MSE (Testing)", side=4, line=3, las=3)
```
